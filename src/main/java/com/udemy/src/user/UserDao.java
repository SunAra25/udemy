package com.udemy.src.user;


import com.udemy.src.user.model.*;
...
public class UserDao {
    ...
    public GetUserInfoRes selectUserInfo(int userIdx){
        String selectUsersInfoQuery = "select u.userIdx as userIdx, \n" +
                ...
                "If(followerCount is null, 0, followingCount) as followingCount \n" +
                "from User as u\n" +
                ...
                "left join (select followerIdx, count(followIdx) as followerCount from Follow where status = 'ACTIVE' group by followerIdx) f on f.followerIdx = u.userIdx \n" +
